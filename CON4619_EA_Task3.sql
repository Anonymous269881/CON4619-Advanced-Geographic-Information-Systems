Create Table task.hong_kong_locations (
id serial PRIMARY KEY,
name VARCHAR(255),
geom geometry(Point, 4326)
);

INSERT INTO task.hong_kong_locations (name, geom) VALUES
...
CREATE TABLE task.hong_kong_locations_buffers (
id serial PRIMARY KEY,
geom geometry(Polygon, 4326)
);

INSERT INTO task.hong_kong_locations_buffers (geom)
SELECT ST_Transform(ST_Buffer(ST_Transform(geom, 3857), 500), 4326)
FROM task.hong_kong_locations;
